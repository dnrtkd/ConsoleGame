...
int main(void)
{
	...
	enemy2->obj.Info.Texture[0] = (char*)"    ∩";
	enemy2->obj.Info.Texture[1] = (char*)"€◎§";
	enemy2->obj.Info.Texture[2] = (char*)"    ∪";
	enemy2->obj.TransInfo.Scale.x = strlen("    ∩");
